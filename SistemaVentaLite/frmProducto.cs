using CapaEntidad;
using CapaNegocio;
using SistemaVentaLite.Utilidades;
    ...
    public partial class frmProducto : Form
    {
        ...
        private void btnguardar_Click(object sender, EventArgs e)
        {
            ...
            Producto obj = new Producto()
            {
                ...
                Stock = Convert.ToDecimal(txtstockproducto.Text),
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    row.Cells["Stock"].Value = Convert.ToDecimal(txtstockproducto.Text).ToString("N2");
                    row.Cells["PrecioVenta"].Value = Convert.ToDecimal(txtprecioproducto.Text).ToString("N2");
        ...
        private void dgvdata_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dgvdata.Columns[e.ColumnIndex].Name == "btnseleccionar")
            {
                ...
                if (indice >= 0)
                {
                    ...
                    txtstockproducto.Text = dgvdata.Rows[indice].Cells["Stock"].Value.ToString();
                    txtprecioproducto.Text = $"{dgvdata.Rows[indice].Cells["PrecioVenta"].Value:N2}";
