...
namespace SistemaVentaLite
{
    public partial class frmVentas : Form
    {
        ...
        {
            txtdocumentocliente.Text = "00000001";
        ...
        private void btnbuscarproducto_Click(object sender, EventArgs e)
        {
            using (var modal = new mdProducto())
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    txtprecio.Text = modal._Producto.PrecioVenta.ToString("N2");
                    txtstock.Text = Convert.ToDecimal(modal._Producto.Stock).ToString("0.00");
                    txtcantidad.Select();
                }
                else
                {
        ...
        private void txtcodproducto_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyData == Keys.Enter)
            {
                ...
                if (oProducto != null)
                {
                    ...
                    txtstock.Text = Convert.ToDecimal(oProducto.Stock).ToString();
